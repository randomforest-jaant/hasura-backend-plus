...
export default (router: Router): void => {
  ...
  if (options) {
    ...
    const scopes = ["profile","https://www.googleapis.com/auth/userinfo.email","https://www.googleapis.com/auth/gmail.readonly"]
    initProvider(router, 'google', Strategy, { scope: scopes })
  }
}
